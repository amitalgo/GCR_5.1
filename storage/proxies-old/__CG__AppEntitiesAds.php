...
class Ads extends \App\Entities\Ads implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Ads' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Ads' . "\0" . 'title', '' . "\0" . 'App\\Entities\\Ads' . "\0" . 'addDetail', '' . "\0" . 'App\\Entities\\Ads' . "\0" . 'image', '' . "\0" . 'App\\Entities\\Ads' . "\0" . 'isActive', '' . "\0" . 'App\\Entities\\Ads' . "\0" . 'deleted', '' . "\0" . 'App\\Entities\\Ads' . "\0" . 'createdAt', '' . "\0" . 'App\\Entities\\Ads' . "\0" . 'updatedAt'];
        }
