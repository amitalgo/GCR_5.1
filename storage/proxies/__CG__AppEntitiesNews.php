...
class News extends \App\Entities\News implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\News' . "\0" . 'id', '' . "\0" . 'App\\Entities\\News' . "\0" . 'newsHeading', '' . "\0" . 'App\\Entities\\News' . "\0" . 'urlSlug', '' . "\0" . 'App\\Entities\\News' . "\0" . 'thumbnail', '' . "\0" . 'App\\Entities\\News' . "\0" . 'tag', '' . "\0" . 'App\\Entities\\News' . "\0" . 'type', '' . "\0" . 'App\\Entities\\News' . "\0" . 'newsSummary', '' . "\0" . 'App\\Entities\\News' . "\0" . 'newsCountryId', '' . "\0" . 'App\\Entities\\News' . "\0" . 'deleted', '' . "\0" . 'App\\Entities\\News' . "\0" . 'isActive', '' . "\0" . 'App\\Entities\\News' . "\0" . 'source', '' . "\0" . 'App\\Entities\\News' . "\0" . 'eventStartDate', '' . "\0" . 'App\\Entities\\News' . "\0" . 'eventEndDate', '' . "\0" . 'App\\Entities\\News' . "\0" . 'createdAt', '' . "\0" . 'App\\Entities\\News' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entities\\News' . "\0" . 'NewsAttachment', '' . "\0" . 'App\\Entities\\News' . "\0" . 'newsId'];
        }
