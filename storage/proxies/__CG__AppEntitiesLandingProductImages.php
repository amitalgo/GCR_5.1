 ...
 */
class LandingProductImages extends \App\Entities\LandingProductImages implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\LandingProductImages' . "\0" . 'id', '' . "\0" . 'App\\Entities\\LandingProductImages' . "\0" . 'productId', '' . "\0" . 'App\\Entities\\LandingProductImages' . "\0" . 'mediaUrl', '' . "\0" . 'App\\Entities\\LandingProductImages' . "\0" . 'attributes', '' . "\0" . 'App\\Entities\\LandingProductImages' . "\0" . 'isActive', '' . "\0" . 'App\\Entities\\LandingProductImages' . "\0" . 'createdAt', '' . "\0" . 'App\\Entities\\LandingProductImages' . "\0" . 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LandingProductImages $proxy) {
