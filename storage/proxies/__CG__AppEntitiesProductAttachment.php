...
class ProductAttachment extends \App\Entities\ProductAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\ProductAttachment' . "\0" . 'id', '' . "\0" . 'App\\Entities\\ProductAttachment' . "\0" . 'productAttachmentId', '' . "\0" . 'App\\Entities\\ProductAttachment' . "\0" . 'priority', '' . "\0" . 'App\\Entities\\ProductAttachment' . "\0" . 'type', '' . "\0" . 'App\\Entities\\ProductAttachment' . "\0" . 'url', '' . "\0" . 'App\\Entities\\ProductAttachment' . "\0" . 'addNo', '' . "\0" . 'App\\Entities\\ProductAttachment' . "\0" . 'addDate', '' . "\0" . 'App\\Entities\\ProductAttachment' . "\0" . 'image'];
        }
