 ...
 */
class ScenarioTitleSlug extends \App\Entities\ScenarioTitleSlug implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\ScenarioTitleSlug' . "\0" . 'id', '' . "\0" . 'App\\Entities\\ScenarioTitleSlug' . "\0" . 'titleId', '' . "\0" . 'App\\Entities\\ScenarioTitleSlug' . "\0" . 'urlSlug', '' . "\0" . 'App\\Entities\\ScenarioTitleSlug' . "\0" . 'updDate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ScenarioTitleSlug $proxy) {
