...
class ScenarioTitle extends \App\Entities\ScenarioTitle implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'id', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'name', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'priority', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'status', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'addNo', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'addDate', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'updNo', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'urlSlug', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'updDate', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'scenarioDetail', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'scenarioTitleSlug', '' . "\0" . 'App\\Entities\\ScenarioTitle' . "\0" . 'verticalImages'];
        }
    ...
    public function getScenarioTitleSlug()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getScenarioTitleSlug', []);

        return parent::getScenarioTitleSlug();
    }
    ...
    public function setScenarioTitleSlug($scenarioTitleSlug)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setScenarioTitleSlug', [$scenarioTitleSlug]);

        return parent::setScenarioTitleSlug($scenarioTitleSlug);
    }
