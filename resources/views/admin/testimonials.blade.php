                ...
                <div class="card-box">
                    <div class="row h6">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-default waves-effect waves-light" href="{{route('admin.testimonials.create')}}"><i class="fa fa-plus"></i> Testimonial</a>
                            @endif
                        </div>
                    </div>
                        ...
                        @forelse($testimonials as $testimonial)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.testimonials.edit',['$testimonials' => $testimonial->getId()])}}" class="btn btn-icon waves-effect waves-light btn-white">
