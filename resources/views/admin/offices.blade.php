                    ...
                    <div class="row h6">
                        ...
                        <div class="col-sm-2">
                            @if(in_array('office.create', $isAuthorize))
                                <a class="btn btn-default waves-effect waves-light" href="{{route('admin.office.create')}}"><i class="fa fa-plus"></i> Add Office</a>
                            @endif
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(in_array('office.edit', $isAuthorize))
                                        <a href="{{route('admin.office.edit',['partners' => $office->getId()])}}" class="btn btn-icon waves-effect waves-light btn-white">
