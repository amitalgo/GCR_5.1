                ...
                <div class="card-box">
                    <div class="row h6">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-default waves-effect waves-light" href="{{route('admin.solutions.create')}}"><i class="fa fa-plus"></i> Solution</a>
                            @endif
                        </div>
                    </div>
                        ...
                        @forelse($solutions as $solution)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.solutions.edit',['soluitons' => $solution->getId()])}}" class="btn btn-icon waves-effect waves-light btn-white">
