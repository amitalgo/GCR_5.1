            ...
            <div class="col-sm-12">
                <div class="card-box">
                    <div class="row h6">
                        ...
                        <div class="col-sm-2">
                            @if(in_array('experience-centre.create', $isAuthorize))
                            <a class="btn btn-default waves-effect waves-light" href="{{route('admin.experience-centre.create')}}"><i class="fa fa-plus"></i> Add</a>
                            @endif
                        </div>
                    </div>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        @forelse($videos as $video)
                            <tr>
                                ...
                                <td>
                                    @if(in_array('experience-centre.edit', $isAuthorize))
                                    <a href="{{route('admin.experience-centre.edit',['experience-centre' => $video->getId()])}}" class="btn btn-icon waves-effect waves-light btn-white">
