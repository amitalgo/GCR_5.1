                ...
                <div class="card-box">
                    <div class="row h6">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-default waves-effect waves-light" href="{{route('admin.users.create')}}"><i class="fa fa-plus"></i> User</a>
                                @endif
                        </div>
                    </div>
                        ...
                        @forelse($users as $user)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.users.edit',['users' => $user->getId()])}}" class="btn btn-icon waves-effect waves-light btn-white">
