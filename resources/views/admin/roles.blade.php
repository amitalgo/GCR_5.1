                ...
                <div class="card-box">
                    <div class="row h6">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-default waves-effect waves-light" href="{{route('admin.roles.create')}}"><i class="fa fa-plus"></i> Role & Permission</a>
                            @endif
                        </div>
                    </div>
                        ...
                        @forelse($roles as $role)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.roles.edit',['roles' => $role->getId()])}}" class="btn btn-icon waves-effect waves-light btn-white">
