                ...
                <div class="card-box">
                    <div class="row h6">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-default waves-effect waves-light" href="{{route('admin.ads.create')}}"><i class="fa fa-plus"></i> Ads</a>
                                @endif
                        </div>
                    </div>
                        ...
                        @forelse($ads as $ad)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.ads.edit',['$ads' => $ad->getId()])}}" class="btn btn-icon waves-effect waves-light btn-white">
