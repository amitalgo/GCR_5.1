...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            @if(in_array('industry.create', $isAuthorize))
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        @forelse($industries as $industry )
                            ...
                            <span class="label label-table label-{{$label = $industry->getIsActive()?"success":"danger"}}">
                                ...
                                <td>
                                    @if(in_array('industry.edit', $isAuthorize))
    ...
    <div id="dataEdit" class="modal-demo">
        ...
        <div class="custom-modal-text">
            <form class="form-horizontal" role="form" id="editCategoryForm" method="POST" action="">
                <div class="form-group">
                    <label class="col-md-2 control-label" for="cat">Industry : </label>
                    <div class="col-md-6">
