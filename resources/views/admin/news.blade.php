                ...
                <div class="card-box">
                    <div class="row h6">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-default waves-effect waves-light" href="{{route('admin.news.create')}}"><i class="fa fa-plus"></i> Add News</a>
                            @endif
                        </div>
                    </div>
                        ...
                        @forelse($news as $new)
                            ...
                            <td class="editTd">
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.news.edit',['partners' => $new->getId()])}}" class="btn btn-icon waves-effect waves-light btn-white">
