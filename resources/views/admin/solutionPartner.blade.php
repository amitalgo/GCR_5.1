                ...
                <div class="card-box">
                    <div class="row h6">
                        ...
                        <div class="col-sm-2">
                            ...
                            <a class="btn btn-default waves-effect waves-light" href="{{route('admin.partners.create')}}"><i class="fa fa-plus"></i> Add Partner</a>
                            @endif
                        </div>
                    </div>
                        ...
                        @forelse($partners as $partner)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('admin.partners.edit',['partners' => $partner->getId()])}}" class="btn btn-icon waves-effect waves-light btn-white">
