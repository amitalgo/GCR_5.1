        ...
        <div class="col-md-12">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control required"  placeholder="Phone" type="text" name="number" onkeypress="return isNumberKey(event)">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control required"  placeholder="Mobile" type="text" name="mobile" onkeypress="return isNumberKey(event)">
                </div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="col-md-12">
                <div class="form-group-text">
                    ...
                    <label>Description</label> <span class="red">* <small></small></span>
        ...
        <div class="col-md-12" style="margin-top: 0px;">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="button" class="btn btn-primary closePopUp" data-dismiss="modal" value="Close"/>
                </div>
            </div>
        </div>
    </form>