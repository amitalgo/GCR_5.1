...
<form action="{{route('contactlanding')}}" method="post">
	...
	<div class="form-group">
        <label>Phone Number</label> <span class="red">* <small></small></span>
        <input class="form-control" required  placeholder="Phone Number" type="text" name="number" onkeypress="return isNumberKey(event)">
    </div>
    <div class="form-group">
        <label>Country</label>
    ...
    <div class="form-group">
        ...
        <label>Products and Solutions you are interested</label>
        <textarea class="form-control"  rows="5" placeholder="Products and Solutions you are interested" name="interested"></textarea>
    </div>
   <div class="clearfix"></div>
             {!! app('captcha')->render() !!}
