...
class VideosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($result){
            return redirect()->route('admin.experience-centre.index')->with('success-msg', ' Experience Centre added successfully.');
        }else{
            return redirect()->route('admin.experience-centre.index')->with('error-msg', ' Something went wrong.');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($result){
            return redirect()->route('admin.experience-centre.index')->with('success-msg', ' Done');
        }else{
            return redirect()->route('admin.experience-centre.index')->with('error-msg', ' Something went wrong.');
        }
    }
