...
class UserController extends Controller
{
    ...
    public function store(Request $request,UserService $userService)
    {
        ...
        if($result){
            return redirect()->route('admin.users.index')->with('success-msg', ' User added successfully.');
        }else{
            return redirect()->route('admin.users.index')->with('error-msg', 'Image is not set OR something went wrong.');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($result){
            return redirect()->route('admin.users.index')->with('success-msg', ' User updated successfully.');
        }else{
            return redirect()->route('admin.users.index')->with('error-msg', 'Something went wrong.');
        }
    }
