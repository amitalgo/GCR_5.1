...
class OfficeServiceImpl implements OfficeService
{
    ...
    public function saveOffice($data)
    {
        ...
        $office->setCity($data['city']!=null?$data['city']:'');
        $office->setState($data['state']!=null?$data['state']:'');
        $office->setAddress1($data['address1']);
        $office->setPincode($data['pincode']);
        $office->setAddress2($data['address2']!=null?$data['address2']:'');
        $office->setCreatedAt(new \DateTime());
        $office->setUpdatedAt(new \DateTime());
